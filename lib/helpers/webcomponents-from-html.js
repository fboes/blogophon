...
const WebcomponentsFromHtml = {
  findComponents: function(html) {
    let componentNames = [];
    if (html) {
      let matches = html.matchAll(/<([a-zA-Z0-9]+-[a-zA-Z0-9-_]+)/g);
  ...
  getScripts: function(webComponents, config) {
    let scripts = {};
  ...
  getConsolidatedComponentScripts: function(index) {
...
module.exports = WebcomponentsFromHtml;
