    ...
    channel: {
      ...
      items: index.map(function(item){
        let returnItem = {
          ...
          atomUpdate: item.meta.Modified ? blogophonDateFormat(item.meta.Modified, 'rfc3339') : null,
          atomUpdateTs: item.meta.Modified ? blogophonDateFormat(item.meta.Modified, 'timestamp') : null,
