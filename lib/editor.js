...
const editor = function(config) {
  ...
  external.filenameFromTitle = function(title) {
    return path.join(config.directories.data, external.shortfilenameFromTitle(title), 'index.md');
  };
   ...
   */
  external.makePost = function(filename, templateData, callback) {
  ...
  external.deleteFile = function(filename, callback) {
    let processed = 0, maxProcessed = 1;
