...
```yaml
Title:        'Title'                       # Title of document. If not set the first line of your Markdown will be used
                                            # as title.
...
Date:         2016-08-25T19:13:12+02:00     # Publishing date in ISO-8601.
                                            # If not set this will be taken from the file date. If this date set into 
                                            # the future, the article will not be published until the date is reached.
