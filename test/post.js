...
exports.testLinks = function(test) {
  ...
  test.equal(testLinks.length, 4);
  test.equal(testLinks[0],    'http://www.1test.com');
  test.equal(testLinks[1],    'http://www.2test.com');
  test.equal(testLinks[2],    'https://www.3test.com');
  test.equal(testLinks[3],    'https://www.5test.com/some-compilcated-foo?a#b');
